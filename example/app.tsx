...
let App = () => (<HashRouter>
  <Scroll height="100vh">
      ...
      <Header className="ru-example-header">
        <div className="ru-example-header__inner">
          ...
          <div className="header-side">
            <a className="header-github" target="_blank" href="https://github.com/linxiaodi/rummy-ui">
      ...
      <Footer className="ru-example-footer">
